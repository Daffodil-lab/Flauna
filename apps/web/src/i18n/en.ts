const en = {
  ...
  "room.map.region": "Map",
  "room.map.charList": "Characters on the map",
  "room.map.empty": "No map data",
  "room.map.currentActor": "Current actor: {{name}}",
  "room.map.noCurrentActor": "Turn order not started",
  "room.map.faction.pc": "PC",
  "room.map.faction.enemy": "Enemy",
  "room.map.faction.neutral": "Neutral",
  "room.map.charSummary":
    "{{name}} · {{faction}} · HP {{hp}}/{{maxHp}} · position ({{x}}, {{y}})",
  "room.map.charDown": "down",
  "room.map.charCurrent": "current actor",
  ...
  "room.chat.tablistLabel": "Chat scope",
  "room.chat.tab.allTabs": "All",
  "room.chat.tab.all": "Public",
  "room.chat.tab.party": "Party",
  "room.chat.tab.whisper": "Whisper",
  "room.chat.scopeLabel": "Send to",
  "room.chat.scope.all": "Public",
  "room.chat.scope.party": "Party",
  "room.chat.scope.whisper": "Whisper",
  "room.chat.whisperToLabel": "Whisper recipient",
  "room.chat.whisperPickRecipient": "Pick recipient",
  "room.chat.whisperFrom": "(whisper from {{name}})",
  "room.chat.whisperTo": "(whisper → {{name}})",
