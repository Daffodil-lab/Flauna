const ja = {
  ...
  "room.evasion.expired": "時間切れ — サーバー処理待ち",
  ...
  "room.map.region": "マップ",
  "room.map.charList": "登場キャラクター",
  "room.map.empty": "マップデータなし",
  "room.map.currentActor": "現在の手番: {{name}}",
  "room.map.noCurrentActor": "手番開始前",
  "room.map.faction.pc": "PC",
  "room.map.faction.enemy": "敵",
  "room.map.faction.neutral": "中立",
  "room.map.charSummary":
    "{{name}}・{{faction}}・HP {{hp}}/{{maxHp}}・位置 ({{x}}, {{y}})",
  "room.map.charDown": "戦闘不能",
  "room.map.charCurrent": "手番中",
  ...
  "room.chat.tablistLabel": "チャットスコープ",
  "room.chat.tab.allTabs": "すべて",
  "room.chat.tab.all": "全体",
  "room.chat.tab.party": "パーティ",
  "room.chat.tab.whisper": "秘話",
  "room.chat.scopeLabel": "送信先",
  "room.chat.scope.all": "全体",
  "room.chat.scope.party": "パーティ",
  "room.chat.scope.whisper": "秘話",
  "room.chat.whisperToLabel": "秘話の宛先",
  "room.chat.whisperPickRecipient": "宛先を選択",
  "room.chat.whisperFrom": "（{{name}} より秘話）",
  "room.chat.whisperTo": "（→{{name}} に秘話）",
